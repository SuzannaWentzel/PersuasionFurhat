...
val standpoint_meat1: State = state(dialogState) {
...
val standpoint_meat2: State = state(dialogState) {
...
val standpoint_meat3: State = state(dialogState) {
...
val standpoint_meat4: State = state(dialogState) {
